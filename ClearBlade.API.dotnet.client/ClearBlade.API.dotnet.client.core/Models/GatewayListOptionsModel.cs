...
namespace ClearBlade.API.dotnet.client.core.Models
{
    public class GatewayListOptionsModel
    {
        ...
        {
            GatewayType = GatewayType.GATEWAY_TYPE_UNSPECIFIED;
            AssociationsGatewayId = string.Empty;
            AssociationsDeviceId = string.Empty;
        }

        public GatewayListOptionsModel(GatewayType gatewayType, string associationsGatewayId, string associationsDeviceId)
        {
